...
const initialState = {
    ...
    appointmentFields:[
        ...
        {field:"location", displayName:"Location",placeholder:"Location", className:"fa fa-map-marker fa-lg" , value:"Chirala",disabled:true,inputType:"inputbox",newline:false}, 
        {field:"patientName", displayName:"Patient Name",required:true, placeholder:"Full name", className:"fa fa-user fa", value:"", optional:false,inputType:"inputbox",validationMsg:"Please enter the User Name",newline:false},         
        {field:"contactnumber", displayName:"Contact Number", placeholder:"ContactNo",className:"" ,  value:"",optional:false,inputType:"inputbox",validationMsg:"Please enter the ContactNo",newline:false},
        ...
        {field:"age", displayName:"Age",required:true,placeholder:"Age", className:"	fa fa-sort", value:"", optional:false,inputType:"inputbox",validationMsg:"Please enter the Age",newline:true},
        ...
        {field:"address", displayName:"Address",required:true, placeholder:"Address", className:"	far fa-building", value:"", optional:false,inputType:"inputbox",validationMsg:"Please enter the Address",newline:false},  
